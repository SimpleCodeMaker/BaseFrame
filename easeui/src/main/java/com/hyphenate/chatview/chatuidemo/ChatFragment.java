...
import com.hyphenate.chatview.chatuidemo.widget.ChatRowConferenceInvitePresenter;
import com.hyphenate.chatview.chatuidemo.widget.EaseChatRecallPresenter;
import com.hyphenate.chatview.chatuidemo.widget.EaseChatVoiceCallPresenter;
...
//        }
        super.setUpView();
        if(leftDrawable!=0){
            titleBar.setLeftImageResource(leftDrawable);
        }
        if(titleColor!=0){
        ...
        titleBar.setRightLayoutVisibility(rightLayoutVisibility);
...
//                }
    ...
    private int rightLayoutVisibility = View.VISIBLE;
    @Override
    ...
    public void setRightLayoutVisibility(int visibility){
        rightLayoutVisibility = visibility;
    }
}
